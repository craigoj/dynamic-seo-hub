...
export const generateContent = (industry: string, industryInfo: IndustryContent) => {
  ...
  const content = `
    <section class="prose prose-lg max-w-none mb-12">
      ...
      <section class="bg-blue-600 text-white p-8 rounded-lg text-center mt-12">
        ...
        <div class="inline-block bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors">
